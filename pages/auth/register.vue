    ...
    <div class="max-w-md w-full space-y-8 bg-white p-8 rounded-lg shadow-lg">
      ...
      <form @submit.prevent="handleRegister" class="space-y-6">
        <div class="relative">
          ...
          <input id="name" name="name" type="text" autocomplete="username" required v-model="name"
        ...
        <div class="relative">
          ...
          <input :type="showPassword ? 'text' : 'password'" id="password" name="password" autocomplete="new-password" required v-model="password"
        ...
        <div class="relative">
          ...
          <input :type="showConfirmPassword ? 'text' : 'password'" id="passwordConfirm" name="passwordConfirm" autocomplete="new-password" required v-model="passwordConfirm"
                 class="appearance-none block w-full pl-10 pr-10 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-primary-500 focus:border-primary-500 sm:text-sm"
